...
SELECT DISTINCT banco_proposta.`ano`, `banco_proposta`.`codigo_programa`, `banco_proposta`.`nome_proponente`, 
...
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'AC';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'AL';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'AP';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'AM';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'BA';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'CE';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'DF';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'ES';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'GO';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'MA';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'MT';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'MS';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'MG';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'PA';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'PB';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'PR';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'PE';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'PI';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'RJ';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'RN';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'RS';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'RO';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'RR';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'TO';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'SE';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'SP';
...
(`banco_proposta`.`proponente` = REPLACE(REPLACE(REPLACE(`proponente_siconv`.`cnpj`, '.', ''), '/', ''), '-', '')) 
LEFT JOIN `siconv_programa` ON (`banco_proposta`.`codigo_programa` = `siconv_programa`.`codigo`) 
WHERE `proponente_siconv`.`municipio_uf_sigla` = 'SC';
