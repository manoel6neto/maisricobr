<h1 class="bg-white content-heading border-bottom" style="text-align: center; margin-top: 50px;">Propostas e Pareceres</h1>
<div class="container theme-showcase">
    ...
    <form class="form-horizontal" role="form" name="carrega_dados" method="post" id="carrega_dados" ></form>
    ...
    <h1 class="bg-white" style="text-align: left;">
        <p>
            <input type="checkbox" name="anos[]" form="carrega_dados" checked="checked" disabled="true" <?php
...
//            }
            ...
            &nbsp;&nbsp;<input disabled="true" checked="checked" type="checkbox" form="carrega_dados"  <?php
...
//                }
            ...
            <select name="status_prop" form="carrega_dados">
                ...
                <option value="3" <?php
                if (isset($filtro['status_prop']) && $filtro['status_prop'] == "3") {
                    echo "selected='selected'";
                }
