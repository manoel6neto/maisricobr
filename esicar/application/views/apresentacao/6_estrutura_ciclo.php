...
<h1 class="bg-white content-heading border-bottom" style="text-align: center">Ciclo anual de oportunidades</h1>
<!-- Tabs -->
<div class="relativeWrap" >
    <div class="box-generic">
        ...
        <div class="tabsbar">
            <ul>
                <li class="glyphicons active"><a href="#" data-toggle="tab"><?= $esfera ?><strong></strong></a></li>
