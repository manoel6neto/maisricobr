...
<div class="innerALl">
    <div class="col-md-12 col-sm-12">
        ...
        <form name="" id="formprop" method="post" action="incluir_proposta" enctype="multipart/form-data">
            ...
            ?>">
            <input type="hidden" name="offline" value="<?php
            if (isset($offline)) {
                echo $offline;
            }
            ?>">
            ...
            <?php if ($id != "") { ?>
                ...
                <?php } else { ?>
                    ...
                    <input  class="btn btn-primary" type="submit" formaction="escolher_proponente?id=<?php echo $id; ?><?php echo $edit; ?>" id="escolhe_orgao" value="Alterar Orgão">
                    <?php //endif;  ?>
                ...
                if (isset($valores_programa)) {
                    foreach ($valores_programa as $valor) {
                        if (is_array($valor))
                            $valor = (object) $valor;
                        ?>
                        <div id="<?= $this->input->get('new_program', TRUE)  == '1' ? $this->input->post('idRowSelectionAsArray')[0] : $valor->id_programa; ?>_modal">
                            <input type="hidden" name="id_programa_proposta[]" value="<?php
                            if (isset($valor->id_programa_proposta)) {
                                echo $valor->id_programa_proposta;
                            }
                            ?>">
                            <input type="hidden" name="id_programa[]" value="<?php echo $this->input->get('new_program', TRUE)  == '1' ? $this->input->post('idRowSelectionAsArray')[0] : $valor->id_programa; ?>">
                            <input type="hidden" name="codigo_programa[]" value="<?php echo $this->input->get('new_program', TRUE)  == '1' ? $new_program_valores->codigo : $valor->codigo_programa; ?>">
                            <input type="hidden" name="nome_programa_modal[]" value="<?php echo $this->input->get('new_program', TRUE)  == '1' ? $new_program_valores->nome : $valor->nome_programa; ?>">
                            <input type="hidden" name="objeto[]" value="<?php echo $this->input->get('new_program', TRUE)  == '1' ? $new_program_valores->objeto : $valor->objeto; ?>">
                            <input type="hidden" name="qualificacao[]" value="<?php echo $this->input->get('new_program', TRUE)  == '1' ? $new_program_valores->qualificacao : $valor->qualificacao; ?>">
                            <input type="hidden" name="percentual[]" value="<?php echo $valor->percentual; ?>">
                            ...
                            <input type="hidden" name="valorContrapartidaBensServicos[]" value="<?php
                            if (isset($valor->contrapartida_bens) && $valor->contrapartida_bens > 0) {
                                echo number_format($valor->contrapartida_bens, 2, ",", ".");
                            }
                            ?>">
                            <input type="hidden" name="valorRepasse[]" value="<?php echo number_format($valor->repasse, 2, ",", "."); ?>">
                            <input type="hidden" name="valorRepassevoluntario[]" value="<?php echo number_format($valor->repasse_voluntario, 2, ",", "."); ?>">
                        </div>
                        <?php
                    }
                }
            ...
            <div id="oculta_padrao">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control campoNumerico"
                           ...
                           onkeyup="verifica()"
                           id="salvarValorContrapartidaBensServicos"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control campoNumerico"
                           name="valorRepassevoluntario_modal" onmouseup="verifica()"
                           onkeyup="verifica()" maxlength="14"
                           id="salvarValorRepassevoluntario"
...
<div id="select_opcao_crono" title="Crono Físico" class="bg-white">
    <form action="#" id="form_modal_crono_fisico">
        <h3 style="color: #428bca;">Crono Físico</h3>
        <input type="hidden" name="id_programa_proposta_modal" value="">
        <div class="col-md-8 bg-white">
            <div class="form-group">
                <input type="radio" name="crono_fisico" value="1" checked="true"> <b>Não alterar</b><br/>
                <input type="radio" name="crono_fisico" value="2"> <b>Recalcular proporcionalmente</b><br/>
                <input type="radio" name="crono_fisico" value="3"> <b>Zerar</b><br/>
            </div>
        </div>
    </form>
</div>
...
<style type="text/css">
    div#preenche_dados_programa div#select_opcao_crono .ui-dialog-titlebar {
...
<?php endif; ?>
                                                                           ...
                                                                           var dialog_dados;
                                                                           var dialog_select_opcao_crono;
                                                                           var idPrograma = null;
                                                                           var codigo_programa = null;
                                                                           var nome_programa = null;
                                                                           var coluna_global = null;

                                                                           dialog_select_opcao_crono = $("#select_opcao_crono").dialog({
                                                                               height: parseInt(screen.height / 2),
                                                                               width: parseInt((screen.width / 4) * 3),
                                                                               modal: true,
                                                                               buttons: {
                                                                                   "Confirmar": function () {
                                                                                       var crono_fisico, campo;
                                                                                       $('#form_modal_crono_fisico input[name="crono_fisico"]').each(function () {
                                                                                           if ($(this).is(":checked"))
                                                                                               crono_fisico = $(this).val();
                                                                                       });
                                                                                       campo = '<input type="hidden" name="opcao_crono_fisico" value="' + crono_fisico + '">'
                                                                                       $("#valores_programa").append("<div id='" + idPrograma + "_modal'>" + campo + "</div>");
                                                                                       console.log(idPrograma);
                                                                                       dialog_select_opcao_crono.dialog("close");
                                                                                   ...
                                                                                   "Confirmar": function () {
                                                                                       ...
                                                                                       if (enviardadosProposta(document.getElementById("form_modal"))) {
                                                                                           ...
                                                                                           var campos = '<input type="hidden" name="id_programa_proposta[]" value="' + $("#form_modal input[name='id_programa_proposta_modal']").val() + '">'
                                                                                                   ...
                                                                                                   + '<input type="hidden" name="valorRepassevoluntario[]" value="' + $("input[name='valorRepassevoluntario_modal']").val() + '">';
                                                                                           ...
                                                                                           $("#form_modal input[name='percentual_modal']").attr('class', 'form-control');
                                                                                           if ('<?= $this->input->get_post('edit') ?>' === '1') {
                                                                                               dialog_select_opcao_crono.dialog("open");
                                                                                               return false;
                                                                                           }
                                                                                           $(this).dialog("close");
                                                                                       }
...
<?php endif; ?>
                                                                           ...
                                                                           function carrega_campos_modal(idPrograma) {
                                                                               if ($("#" + idPrograma + "_modal").length) {
                                                                                   ...
                                                                                   $("#form_modal input[name='valorRepassevoluntario_modal']").val($("#" + idPrograma + "_modal input[name='valorRepassevoluntario[]']").val());
                                                                               }
                                                                           }
                                                                           ...
                                                                           function exibe_valores_globais() {
                                                                               ...
                                                                               $("input[name='idRowSelectionAsArray[]']").each(function (idx, value) {
                                                                                   console.log($("input[name='idRowSelectionAsArray[]']"));
                                                                           ...
                                                                           $("#avanca_form").click(function () {
                                                                               ...
                                                                               if (parseFloat(total) < parseFloat(100000.00)) {
                                                                                   alert('Verifique se para o seu proponente o valor de repasse total pode ser inferior a R$ 100.000,00 (cem mil reais)');
                                                                                   return true;
                                                                               }
