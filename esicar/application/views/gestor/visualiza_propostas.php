                    ...
                    <?php if (isset($propostas_cadastradas) AND $propostas_cadastradas != null) { ?>
                        ...
                        <div class="widget borders-none">
                            <div class="widget-body ">
                                <?php $i = 0; ?>
                                <?php foreach ($propostas_cadastradas as $proponente => $propostas): ?>
                                    <?php
                                    $qtd = 0;
                                    foreach ($propostas as $proposta) {
                                        $temAlerta = false;
                                        $panel = "collapse";
                                        foreach ($cnpjs as $cidade => $cnpj) {
                                        ...
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?php echo $i; ?>">
                                                    <?php echo substr($propostas[0]->proponente, 0, 2) . '.' . substr($propostas[0]->proponente, 2, 3) . '.' . substr($propostas[0]->proponente, 5, 3) . '/' . substr($propostas[0]->proponente, 8, 4) . '-' . substr($propostas[0]->proponente, 12, 2) . ' - ' . $proponente; ?><span style="color: red; font-size: 16px;"><?php echo " ({$qtd})"; ?></span>
                                                </a>
                                                <?php if ($temAlerta): ?>
                    ...
                    <?php if (isset($propostas_enviadas) AND $propostas_enviadas != null) { ?>
                        ...
                        <div class="widget borders-none">
                            <div class="widget-body ">
                                ...
                                <?php foreach ($propostas_enviadas as $proponente => $propostas): ?>
                                    <?php
                                    $qtd = 0;
                                    foreach ($propostas as $proposta) {
                                        $panel = "collapse";
