<div class="login spacing-x2" style="padding-top: 5%; margin-bottom: 60px !important;">
    <div class="col-md-8 col-sm-8 col-sm-offset-2 bg-white" style="margin-bottom: 60px !important;">
        ...
        <form name="" method="post" id="formprop" action="selecionar_programas"
            ...
            ?>">
            <input type="hidden" name="offline" value="<?php if (isset($offline)) {
                echo $offline;
            } ?>">
