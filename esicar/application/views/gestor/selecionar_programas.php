		...
		<h3 style="color: #428bca;">Selecionar Programas para Proposta</h3>
				...
				<form name="" id="formprop" method="post" action="incluir_proposta" enctype="multipart/form-data">
	                ...
	                <?php //endif;?>
                        ...
                        <input  class="btn btn-primary" type="submit" name="finaliza_selecao" formaction="informa_valores_programa?id=<?php echo $id; ?><?php echo $edit; ?><?= $edit == '&edit=1' ? '&new_program=1' : ''?>" id="finaliza_selecao" value="Finalizar">
