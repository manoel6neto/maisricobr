                ...
                <?php if (isset($propostas) AND $propostas != null) { ?>
                    ...
                    foreach ($propostas as $proposta) {
                        ...
                        if ($areanome == "" || $areanome !== $proposta->areanome) {
                            if ($i > 1) {
                                /* Se não é a primeira iteração, então um cabeçalho já foi criado.
                                 * 
                                 * As 3 divs fecham o panel, o collapse e o panel-body abertos a seguir -->";
                                 */
                                ?> </div></div></div> <?php
                }
                $qtdArea = 0;
                                    ...
                                    <ul class="media-list">
                                        <li class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="clearfix pull-left">
                                                    <?php if ($this->session->userdata('nivel') == 1): ?>
                                                        <input type="text" class="atende_a" id="<?php echo $proposta->idProposta; ?>" size="50" value="<?php
                                                        if (isset($proposta->banco_atende)) {
                                                            echo $proposta->banco_atende;
                                                        }
                                                        ?>">
                                                    <?php else: ?>
