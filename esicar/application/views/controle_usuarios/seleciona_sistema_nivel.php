...
<h1 class="bg-white content-heading border-bottom">Selecionar Sistema & Perfil</h1>
...
<div class="form-group">
	<?php echo form_label('Perfil', 'perfil'); ?>
	<?php echo form_dropdown('perfil', $perfis, '', "id='perfil' class='form-control'"); ?>
</div>
