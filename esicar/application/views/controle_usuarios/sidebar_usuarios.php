    ...
    <div class="sidebar bg-white" style="border-right: solid 2px lightgray;">
        <div class="sidebarMenuWrapper" style="top: 0px;">
            <ul class="list-unstyled">
                ...
                <?php else: ?>
                    <li><a href="<?= base_url(); ?>index.php/in/dados_siconv/visualiza_propostas_por_objeto"><span><i class="fa fa-home"></i> Home</span></a></li>
                <?php endif; ?>

                <?php if ($this->session->userdata('nivel') != 3 && $this->session->userdata('nivel') != 5): ?> 	
                    <li class="<?php echo $acitiveUsuarios; ?>"><a href="<?= base_url(); ?>index.php/controle_usuarios"><span><i class="fa fa-user"></i> Gerenciar Usuários</span></a></li>

                    <?php if ($this->session->userdata('tipo_gestor') != 10): ?>    
                        <?php if ($permissoes->vincular_cnpj_usuario && $this->session->userdata('nivel') != 4 && $this->session->userdata('nivel') != 15): ?>
                        ...
                        <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 2 || $this->session->userdata('nivel') == 6 || $this->session->userdata('nivel') == 12 || $this->session->userdata('nivel') == 13 || $this->session->userdata('nivel') == 15): ?>
                        ...
                        <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 2 || $this->session->userdata('nivel') == 15): ?>
