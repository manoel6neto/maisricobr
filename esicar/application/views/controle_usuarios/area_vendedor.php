<div id="content" class="innerAll bg-white">
	...
	<div class="panel-heading">
		<h4 class="panel-title"><a href="<?php echo base_url('index.php/relatorio/rel_visita_representante'); ?>"><span style="color: #428bca;">Resumo de Visitas Realizadas</span></a></h4>
	</div>
			...
			success:function(data){
				if(data == "SEM_CADASTRO"){
					if(confirm("Para criar uma proposta comercial, primeiro realize um cadastro de visita do município.\r\nDeseja realizar o cadastro agora?")){
						$.ajax({
							url:"<?php echo base_url('index.php/controle_usuarios/cria_cadastro_visita_proposta')?>",
							success:function(data){
