...
<div class="login spacing-x2">
	<div class="col-md-4 col-sm-6 col-sm-offset-4">
		...
		<div class="innerAll text-center"><img src="<?php echo base_url(); ?>layout/assets/images/img_login_municipal.png" width="100%" height="100%"/></div>
		...
		<h4 class="innerAll margin-none text-center"><i class="fa fa-lock"></i> Faça o seu login</h4>
			...
			<div class="panel panel-default">
				<div class="panel-body innerAll">
					...
					<br>
						<a href="<?php echo base_url('index.php/in/municipal/recupera');?>" class=""> Esqueci minha senha </a>
...
// 	});
	...
	function checaCampo(valor, msgRetorno, ehSenha){
		$.ajax({
			url:'<?php echo base_url('index.php/in/municipal/validaCampos')?>',
			type:'post',
			dataType:'html',
			data:{
				valorCampo:valor,
