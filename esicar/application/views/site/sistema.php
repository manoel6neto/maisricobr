...
<div id="conteudoSistema">			
		...
		<div class="dadosTableTexto">
			...
			<div>Além disso, a plataforma WEB - e-SICAR possui um Banco de Projetos com propostas semiestruturadas, sendo necessária a inclusão de algumas informações especificas da entidade do proponente (banco, endereço etc...). Estes projetos são aplicáveis a diversos Ministérios, diminuindo assim, o tempo de trabalho na construção de uma nova proposta.</div>
			
			<div>Após a seleção dos programas na plataforma WEB - e-SICAR, o sistema permite a criação de um novo projeto “fora” do SICONV (gerando projetos em “espelho”), e o cadastramento posterior deste projeto é feito automaticamente pelo e-SICAR rapidamente para o SICONV, gerando o número da proposta. </div>
			
			<div>Com a plataforma WEB - e-SICAR, também é feito um Controle de pareceres das Propostas, atualizados em tempo real diretamente na área do cliente, o que permite a agilidade no acompanhamento das diligências exigidas pelos técnicos do SICONV, tento assim, controle total das propostas enviadas para analise, aumenta a possibilidade de aprovação das mesmas.</div>
		</div>
