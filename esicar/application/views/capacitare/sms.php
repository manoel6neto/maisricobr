    ...
    <div class="box_celulares">
        <form id="capacitare" method="post">
            ...
            <?php if ($capacitare_sms != NULL && count($capacitare_sms) > 0): ?>
                ...
                <textarea class="boxsizingBorder noresize" rows="7" cols="140" contenteditable="true" contextmenu="true" id="mensagem" name="mensagem" draggable="false" maxlength="100" title="Mensagem"></textarea><br />
