    ...
    <div class="box_email">
        <form id="capacitare" method="post">
            ...
            <?php if ($capacitare_email != NULL && count($capacitare_email) > 0): ?>
                ...
                <input class="form-control" type="text" id="assunto" name="assunto" style="width: 100%;" title="Assunto"/><br /><br />
                <label for="mensagem">Mensagem:</label><br />
                <textarea class="form-control noresize" rows="7" cols="140" id="mensagem" name="mensagem" draggable="false" maxlength="1000" title="Mensagem"></textarea><br />
