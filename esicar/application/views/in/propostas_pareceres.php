...
<?php endif; ?>
    ...
    <h1 class="bg-white" style="text-align: left;">
        <p>
            <input type="checkbox" name="anos[]" form="carrega_dados" <?php if (isset($filtro['anos']) && in_array("TODOS", $filtro['anos'])) {
    echo "checked='checked'";
} ?> value="TODOS" class="selecionarTodos">&nbsp;<span style="color: #428bca; font-size: 14px;">Todos os anos</span>
<?php foreach ($anos as $ano): ?>
                &nbsp;&nbsp;<input type="checkbox" form="carrega_dados" <?php if (isset($filtro['anos']) && in_array($ano->ano, $filtro['anos'])) {
        echo "checked='checked'";
...
<?php endforeach; ?>
            ...
            <select name="status_prop" form="carrega_dados">
                ...
                <option value="1" <?php if (isset($filtro['status_prop']) && $filtro['status_prop'] == "1") {
    echo "selected='selected'";
} ?>>Cadastradas e não enviadas</option>
                <option value="2" <?php if (isset($filtro['status_prop']) && $filtro['status_prop'] == "2") {
    echo "selected='selected'";
} ?>>Enviadas para análise</option>
                <option value="3" <?php if (isset($filtro['status_prop']) && $filtro['status_prop'] == "3") {
    echo "selected='selected'";
} ?>>Enviadas e aprovadas</option>
            </select>
            <input type="hidden" value="<?php if (isset($filtro['status_prop'])) {
...
<!-- 		<a class="btn btn-info" title="Atualizar Informações" id="atualizaParecer"><i class="fa fa-refresh"></i></a> -->
        ...
        <?php endif; ?>
                    ...
                    <td><?= $propostas->convenio != NULL ? $propostas->convenio : '-' ?></td>
                ...
                <?php endif; ?>
                    ...
                    <td style="text-align: center;"><?php echo implode("/", array_reverse(explode("-", $propostas->data))); ?></td>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Propostas Ano:</b></td>
                    ...
                    <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "1")): ?>
                        <tr style="color: red;">
                            ...
                            <td></td>
                            <td></td>
                            <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Cadastrado Ano:</b></td>
                    ...
                    <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "2")): ?>
                        <tr style="color: #428bca;">
                            ...
                            <td></td>
                            <td></td>
                            <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Enviadas Análise Ano:</b></td>
            ...
            <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "3")): ?>
                        <tr style="color: green;">
                            ...
                            <td></td>
                            <td></td>
                            <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Aprovado:</b></td>
        ...
        <?php $i++; ?>
            ...
            <tr>
                ...
                <td></td>
                <td></td>
                <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Geral Propostas Ano:</b></td>
    ...
    <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "1")): ?>
                <tr style="color: red;">
                    ...
                    <td></td>
                    <td></td>
                    <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Geral Cadastrado Ano:</b></td>
    ...
    <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "2")): ?>
                <tr style="color: #428bca;">
                    ...
                    <td></td>
                    <td></td>
                    <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Geral Em Análise Ano:</b></td>
        ...
        <?php if (!isset($filtro['status_prop']) || $filtro['status_prop'] == "" || (isset($filtro['status_prop']) && $filtro['status_prop'] == "3")): ?>
                <tr style="color: green;">
                    ...
                    <td></td>
                    <td></td>
                    <td colspan='<?= 1 + $acrecimo; ?>'><b>Total Geral Aprovado:</b></td>
