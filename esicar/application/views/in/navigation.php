<div class="navbar navbar-fixed-top bg-white main" role="navigation">
    ...
    <div class="navbar-header">
        <div class="navbar-brand">
            ...
            <?php if ($this->session->userdata('gp') == TRUE): ?>
                <a href="<?php echo base_url(); ?>index.php/in/gestor" class="appbrand innerL texto"><img src="<?php echo base_url() ?>layout/assets/images/logo_gestao_menu.png" style="width: 180px;"/></a>
            <?php elseif ($this->session->userdata('sistema') == 'P'): ?>
                <a href="<?php echo base_url(); ?>index.php/in/gestor" class="appbrand innerL texto"><img src="<?php echo base_url() ?>layout/assets/images/Imagem interna parlamentar.png" style="width: 200px;"/></a>
            <?php elseif ($this->session->userdata('sistema') == 'M' && $this->session->userdata('nivel') != 9 || $this->session->userdata('sistema') == 'O'): ?>
                <a href="<?php echo base_url(); ?>index.php/in/gestor" class="appbrand innerL texto"><img src="<?php echo base_url() ?>layout/assets/images/Imagem interna municipios.png" style="width: 200px;"/></a>
            <?php elseif ($this->session->userdata('sistema') == 'E'): ?>
                <a href="<?php echo base_url(); ?>index.php/in/gestor" class="appbrand innerL texto"><img src="<?php echo base_url() ?>layout/assets/images/Imagem interna estados.png" style="width: 200px;"/></a>
            <?php elseif ($this->session->userdata('nivel') == 9): ?>
                <a href="<?php echo base_url(); ?>index.php/in/gestor" class="appbrand innerL texto"><img src="<?php echo base_url() ?>layout/assets/images/logo_e_sicar.png" style="width: 90px;"/></a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <ul class="nav navbar-nav  navbar-right hidden-xs">
        ...
        <?php if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 12 || $this->session->userdata('nivel') == 13 || $this->session->userdata('nivel') == 15 || ($this->session->userdata('nivel') == 2 && $this->session->userdata('tipo_gestor') != 10) || $this->session->userdata('nivel') == 4 || $this->session->userdata('nivel') == 6) { ?>
            <?php if ($this->session->userdata('nivel') == 4): ?>    
                <li title="Apresentação">
                    <a href="javascript:window.open('<?php echo base_url(); ?>index.php/apresentacao','window','location=false, toolbar=no, menubar=no, resizable=yes');" title="Apresentação" target="_blank" class="menu-icon"><i class="fa fa-question-circle"></i></a>
                </li>    
            <?php endif; ?>
