...
$filtro_lista_cnpjs = $filtro['filtro_cnpj'];
unset($filtro['filtro_cnpj']);
?>
<style>
    .panel-heading {
        margin: 10px;
...
<div id="content" class="bg-white">
    <h1 class="bg-white content-heading border-bottom">Emendas Disponíveis&nbsp;<img src="<?php echo base_url(); ?>layout/assets/images/loader.gif" style="width: 30px;" id="loader"></h1>
    <div id="form-search">
                ...
                <div id="collapse-1-1" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" name="carrega_dados"
                              method="post" id="carrega_dados" action="busca_emendas_municipio">
                            <div class="row">
                                <div class="col-md-4">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="checkbox">
                                                <label class="checkbox-custom"> <i
                                                        ...
                                                        value="vigencia" id="vigencia" /> Emendas/recurso do concedente em vigência
                                                </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group col-md-10">
                                        ...
                                        <label class="checkbox"> 
                                            <input type="checkbox"
                                                   id="prop1especifico" class="obrigaQualificacao" name="qualificacao[]" <?php if (($filtro == null || in_array("Proposta de Proponente Específico do Concedente", $filtro['qualificacao'])) && (!$usuario_parlamentar)) { ?>checked="checked"<?php } ?>
                                        ...
                                        <label class="checkbox"> 
                                            <input type="checkbox"
                                                   id="prop1emenda" class="obrigaQualificacao" name="qualificacao[]" <?php if (($filtro == null || in_array("Proposta de Proponente de Emenda Parlamentar", $filtro['qualificacao'])) && (!$usuario_parlamentar)) { ?>checked="checked"<?php } ?> 
                                            ...
                                            <?php foreach ($cnpjs as $cnpj) { ?>
                                                ...
                                                <label> 
                                                    <input type="checkbox" class="cnpj"
                                                           name="cnpj[]" <?php if ((isset($filtro['cnpj']) && in_array($cnpj->cnpj, $filtro['cnpj'])) || $filtro == null) { ?>checked="checked"<?php } ?>
...
<?php if (isset($lista) AND $lista != null) { ?>
    <h1 class="bg-white" style="text-align: right;">
        ...
        <span>Emendas Específicas do Concedente: <span class="num_prog" style="font-size: 22px;"><?= $quantidade_especifico; ?></span></span>
        <br>
        <span>Emendas Parlamentares: <span class="num_prog" style="font-size: 22px;"><?= $quantidade_parlamentar; ?></span></span>
        <br>
        <span>Programas: <span class="num_prog" style="font-size: 22px;"><?php echo $num_rows; ?></span></span>
        <br>
        <span>Valor Emendas Disponibilizadas: <span class="num_prog" style="font-size: 22px;">R$ <?= number_format($valor_emendas_disponibilizadas, 2, ',', '.');; ?></span></span>
        <br>
        <span>Valor Emendas utilizadas: <span class="num_prog" style="font-size: 22px;">R$ <?= number_format($valor_emendas_utilizados, 2, ',', '.');; ?></span></span>
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        if (isset($programa->codigo_beneficiario)) {
                                            $dados_emenda = $programa_model->get_dados_beneficiario($programa->codigo_beneficiario, $filtro_lista_cnpjs['cnpj'], true);
                                            foreach ($dados_emenda as $d) {
                                                echo "<br><label class=\"label label-info\">" . ($d->emenda != "" ? "Emenda" : "Específico Concedente") . ":</label> " . $d->emenda_cnpj . "|" . $d->emenda_nome . "|" . $d->emenda_valor;
                                                ...
                                                if (isset($d->emenda) && $d->emenda != "")
                                                    ...
                                                    echo "<br><label class=\"label label-info\">Orgão:</label> " . $programa->orgao_vinculado;
    ...
    ?>
    <h3 style="text-align: center;">Nenhuma emenda/recurso do concedente disponível no momento.</h3>
<?php } ?>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#gerarPdf2").click(function () {
            ...
            if (qtdCNPJ <= 0) {
                alert("Selecione ao menos um CNPJ para gerar o relatório.");
                return false;
            }
...
<div id="dialog-form" title="Enviar Relatório de Emendas/Beneficiário">
    <form>
        <fieldset>
            <label for="assunto">Assunto</label><br>
            <input type="text" name="assunto" size="40" id="assunto" value="Lista de Emendas Disponiveis" class="text ui-widget-content ui-corner-all" style="color: black;"><br>
