<div class="innerALl col-md-12 col-sm-12" style="margin-bottom: 60px !important;">
    ...
    <a class="btn btn-<?php echo $corBotao; ?>"href="<?php echo base_url(); ?>index.php/in/usuario/incluir_parcela_do_cronograma_de_desembolso?id=<?php echo $id; ?>&edita_gestor=<?php echo $edita_gestor; ?>">Adicionar Desembolso</a>
    <a class="btn btn-<?php echo $corBotao; ?>" onclick="return confirm('Tem certeza que deseja excluir o desembolso existente e gerar um novo automaticamente?')"  href="<?php echo base_url(); ?>index.php/in/usuario/incluir_parcela_do_cronograma_de_desembolso_automaticamente?id=<?php echo $id; ?>&edita_gestor=<?php echo $edita_gestor; ?>">Adicionar Automaticamente</a>
    <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/in/usuario/listar_obras?id=<?php echo $id; ?>&edita_gestor=<?php echo $edita_gestor; ?>">Avançar</a>
</div>
