                                ...
                                <div class="col-md-4">
                                    <div class="form-group col-md-10">
                                        ...
                                        <?php if ($this->session->userdata('nivel') == 1): ?>
                                                                                                                                                <label class="checkbox">
                                                                                                                                                <input type="text" class="cnpj" name="cnpj[]" id="num_cnpj" value="<?php
                                            if (isset($filtro['cnpj'])) {
                                                echo $filtro['cnpj'][0];
                                            }
                                            ?>">
                                                                                                                                                </label>
...
<!--                                        <label class="checkbox"> <input type="checkbox"
                                        ...
                                        <label class="checkbox"> <input type="checkbox"
                                                                        class="obrigaAtende" id="prop1entidade" name="atende[]" <?php if (($usuario_parlamentar && !isset($filtro['atende'])) || (isset($lista_entidades) && $lista_entidades['eco_mista'] && !isset($filtro['atende'])) || (isset($filtro['atende']) && in_array("Empresa pública/Sociedade de economia mista", $filtro['atende']))) { ?>checked="checked"<?php } ?>
                                                                        value="Empresa pública/Sociedade de economia mista" > 
                                            <b>Empresas Públicas/Economia Mista</b>
                                        </label>
                                        ...
                                        <label class="checkbox"> <input type="checkbox"
                                            ...
                                            <b>Consórcios Públicos</b>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <!-- Remoção do checkbox para exibir programas ocultos
                                                        <div class="form-group">
                                                            <div class="col-md-12">
    ...
    <?php if (isset($lista) AND $lista != null) { ?>
        <h1 class="bg-white" style="text-align: right;">
            ...
            <span>
                PROGRAMAS: <span class="num_prog" style="font-size: 22px;"><?php echo $num_rows; ?></span><br>
                <!--
                TOTAL: <?php
                ...
                ?>
                -->
                PROGRAMAS UTILIZADOS: <span class="num_prog" style="font-size: 22px;"><?php echo $num_programas_utilizados; ?></span><br>
                PROPOSTAS: <span class="num_prog" style="font-size: 22px;"><?php echo $num_propostas_programas; ?></span>
            </span>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="pull-left">
                                    ...
                                    <a class="atualizaPrograma fa fa-refresh" style="border-radius: 2%; margin-right: 10px;" title="Atualizar Programa" id="<?php echo explode('&path', explode('?id=', $programa->link)[1])[0]; ?>"></a>

                                    <?php
                                    if (in_array($programa->codigo, $codigos_ocultos)) {
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="panel">
                                                    ...
                                                    <div id="collapse-<?php echo $programa->codigo . "-" . $xyz; ?>" class="panel-collapse collapse">
                                                        ...
                                                        <br>
                                                        <b>Qualificação da Proposta:</b> <?php echo $programa->qualificacao; ?>
                                                        <br>
                                                        <b>Qualificação do Proponente:</b> <?php echo $programa->atende; ?>
                                                        <br>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <?php if (isset($programa->anexos)): ?>
                                                                <?php if ($programa->anexos == 1): ?>
                                                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?php echo 'anexo' . "-" . $xyz; ?>"><label class="label label-info">Anexos</label></a> Sim <br>
                                                                    <div id="collapse-<?php echo 'anexo' . "-" . $xyz; ?>" class="panel-collapse collapse">
                                                                        <div class="panel-body">
                                                                            <table>
                                                                                <tr>
                                                                                    <th>
                                                                                ...
                                                                                <?php if (isset($anexos[explode('=', $programa->link)[1]])): ?>
                                                                                    <?php foreach ($anexos[explode('=', $programa->link)[1]] as $value): ?>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <?= $value['nome_arquivo'] ?>
                                                                                            </td>
                                                                                            ...
                                                                                            <td>
                                                                                                <a href="https://www.convenios.gov.br<?= $value['link'] ?>">Download</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    <?php endforeach; ?>
                                                                                <?php endif; ?>
                                                            ...
                                                            <?php if ($programa->edital == 1): ?>
                                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse-<?php echo 'edital' . "-" . $xyz; ?>"><label class="label label-info">Edital</label></a> Sim <br>
                                                                <div id="collapse-<?php echo 'edital' . "-" . $xyz; ?>" class="panel-collapse collapse">
                                                                    <div class="panel-body">
                                                                        <table>
                                                                            <tr>
                                                                                <th>
                                                                            ...
                                                                            <?php if (isset($editais[explode('=', $programa->link)[1]])): ?>
                                                                                <?php foreach ($editais[explode('=', $programa->link)[1]] as $value): ?>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <?= $value['nome_arquivo'] ?>
                                                                                        </td>
                                                            ...
                                                            <?php else: ?>    
                                                                <label class="label label-info">Edital:</label> Não <br>
                                                            <?php endif; ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".oculta_programa").live("click", function () {
            var id = $(this).attr('id');
            $.ajax({
                ...
                success: function () {
                    $("#loader").hide();
                    /* O item vai ser collapsed e não removido - não precisa decrementar o número de programas
                     $("#" + id + "_ocultar").remove();
                    ...
                    $("#collapse-" + id + "-oc").collapse('hide');
                    $("#" + id).text("Desocultar Programa");
                    $("#" + id).addClass("label-info").removeClass("label-success");
                    $("#" + id).addClass("desoculta_programa").removeClass("oculta_programa ");
                }
            });
        });

        $(".desoculta_programa").live("click", function () {
            var id = $(this).attr('id');
            $.ajax({
                url: '<?php echo base_url('index.php/in/dados_siconv/desoculta_programas'); ?>',
                dataType: 'html',
                type: 'post',
                data: {
                    idsPrograma: id
                ...
                success: function () {
                    ...
                    $("#collapse-" + id + "-oc").collapse('show');
                    $("#" + id).text("Ocultar Programa");
                    $("#" + id).addClass("label-success").removeClass("label-info");
                    $("#" + id).addClass("oculta_programa").removeClass("desoculta_programa");
                }
            });
        });
