...
<div id="tituloListagem" class="innerALl col-md-12 col-sm-12" style="margin-bottom: 60px !important;">    
    <?php
    if (isset($idTrabalho)) {
    ...
    <div style="overflow-x: auto;" id="bens">
        <table class="table" id="row">
            <thead>
                <tr>
                    <th class="tipoDespesa">Status</th>
            ...
            <tbody id="tbodyrow">
                ...
                foreach ($despesas as $i => $despesa) {
                    ...
                    <tr class="odd">
                        <td>
                            <?php if ($despesa->id_programa == NULL) : ?>
                                <?php $status = '<i title="Pendente" class="btn-sm btn-primary fa fa-warning"></i>'; ?>
                            <?php else: ?>
                                <?php $status = '<i title="Completo" class="btn-sm btn-success fa fa-check-square"></i>'; ?>
    <?php endif; ?>
    <?= $status; ?>
                        </td>
                        <td>
    ...
    <?php echo $despesa->descricao ?>
                        ...
                        <td>
                            <div class="unidade"><?php echo $despesa->fornecimento ?></div>
                        </td>
                        <td>
        ...
        <table class="table" id="row">
            ...
            <tbody id="tbodyrow">
                <tr class="odd">
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[1][0]) !== false) echo number_format($total[1][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[1][1]) !== false) echo number_format($total[1][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[1][2]) !== false) echo number_format($total[1][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[1][3]) !== false) echo number_format($total[1][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td></tr>
                <tr class="even">
                    <td>
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[2][0]) !== false) echo number_format($total[2][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[2][1]) !== false) echo number_format($total[2][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[2][2]) !== false) echo number_format($total[2][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[2][3]) !== false) echo number_format($total[2][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td></tr>
                <tr class="odd">
                    <td>
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[3][0]) !== false) echo number_format($total[3][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[3][1]) !== false) echo number_format($total[3][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[3][2]) !== false) echo number_format($total[3][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[3][3]) !== false) echo number_format($total[3][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                </tr>
                <tr class="even">
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[4][0]) !== false) echo number_format($total[4][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[4][1]) !== false) echo number_format($total[4][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[4][2]) !== false) echo number_format($total[4][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[4][3]) !== false) echo number_format($total[4][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                </tr>
                <tr class="odd">
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[6][0]) !== false) echo number_format($total[6][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[6][1]) !== false) echo number_format($total[6][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[6][2]) !== false) echo number_format($total[6][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[6][3]) !== false) echo number_format($total[6][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                </tr>
                <tr class="even">
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[5][0]) !== false) echo number_format($total[5][0], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[5][1]) !== false) echo number_format($total[5][1], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[5][2]) !== false) echo number_format($total[5][2], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[5][3]) !== false) echo number_format($total[5][3], 2, ",", ".");
                else echo "0,00"; ?></div>
                    </td></tr>
                <tr class="odd">
                    <td>
                    ...
                    <td>
                        <div class="valorTotal">R$ <?php if (isset($total[0][0]) !== false) echo number_format($total[0][0], 2, ",", ".");
    else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorContrapartida">R$ <?php if (isset($total[0][1]) !== false) echo number_format($total[0][1], 2, ",", ".");
    else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorBensServicos">R$ <?php if (isset($total[0][2]) !== false) echo number_format($total[0][2], 2, ",", ".");
    else echo "0,00"; ?></div>
                    </td>
                    <td>
                        <div class="valorAplicacao">R$ <?php if (isset($total[0][3]) !== false) echo number_format($total[0][3], 2, ",", ".");
    else echo "0,00"; ?></div>
                    </td>
                </tr>
            </tbody>
