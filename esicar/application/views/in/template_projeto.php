	 ...
	 <div class="bg-white innerAll menu">
		<div class="wizard-head hidden-xs">
			<ul class="bwizard-steps">
				...
				<li class="<?php echo $activeEscPropo; ?>"><a href="<?php if (isset($_GET['id']) && !isset($_GET['padrao'])) {echo base_url()."index.php/in/gestor/informa_valores_programa?id=".$id."&edit=1";}?>">Orgão &amp; Programa</a></li>
				<!--<li class="<?php echo $activeSelProg; ?>"><a href="<?php if (isset($_GET['id'])) {echo base_url()."index.php/in/gestor/selecionar_programas?id=".$id;}?>">Programa</a></li>-->
				<li class="<?php echo $activeIncProp; ?>"><a href="<?php if (isset($_GET['id']) && !isset($_GET['padrao'])) {echo base_url()."index.php/in/gestor/incluir_proposta?edit=1&id=".$id;}?>">Dados da Proposta</a></li>
				
				<?php if(!isset($_GET['padrao']) || (isset($_GET['padrao']) && $this->session->userdata('nivel') == 1)):?>
				<li class="<?php echo $activeIncJus; ?>"><a href="<?php if (isset($_GET['id'])) {echo base_url()."index.php/in/usuario/incluir_justificativa?id=".$id."&edita_gestor=1";}?>">Justificativa</a></li>
				<li class="<?php echo $activeListMetas; ?>"><a href="<?php if (isset($_GET['id'])) {echo base_url()."index.php/in/usuario/listar_metas?id=".$id."&edita_gestor=1";}?>">Crono Físico</a></li>
				<li class="<?php echo $activeListCron; ?>"><a href="<?php if (isset($_GET['id'])) {echo base_url()."index.php/in/usuario/listar_cronograma?id=".$id."&edita_gestor=1";}?>">Crono Desembolso</a></li>
				<li class="<?php echo $activeListObra; ?>"><a href="<?php if (isset($_GET['id'])) {echo base_url()."index.php/in/usuario/listar_obras?id=".$id."&edita_gestor=1";}?>">Plano Detalhado</a></li>
				<?php endif;?>
				...
				<li class="last-child <?php echo $activeVisProp; ?>"><a href="<?php if (isset($_GET['id'])) {echo "visualiza_proposta?id=".$id;}?>"><?php echo $label; ?></a></li>
				<?php endif;?>
