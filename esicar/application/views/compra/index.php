<div class="login spacing-x2">
	<div class="col-md-6 col-sm-6 col-sm-offset-3">
            <div style="background-color: white; border: solid #D8D8D8; border-width: thin; border-bottom: whitesmoke;">
...
<!--				    				<td>
		  								<input type="checkbox" name="tipo_servico_ED" class="tipo_servico" id="tipo_servico_ED" value="ED" <?php if($ED){echo "checked='checked'";}?>/>
				    					<label for="">Emendas Parlamentares</label>
				    				</td>-->
                ...
                <div style="background-color: white; border: solid #D8D8D8; border-width: thin; margin-bottom: 70px; margin-top: 0px;">
