...
class relatorio extends BaseController {
    ...
    public function index() {
        ...
        if ($this->session->userdata('gp') == true || $this->input->get('gp', TRUE) != false) {
            $data['title'] = 'G&P - Relatórios';
        } else {
            $data['title'] = 'Physis - Relatórios';
        }
    ...
    public function rel_proj_desenv() {
        ...
        $data['title'] = 'Physis - Relatório Projetos Desenvolvidos';
    ...
    public function rel_atividade_usuario() {
        ...
        $data['title'] = 'Physis - Relatório Atividade Usuário';
    ...
    public function rel_desempenho_sistema() {
        ...
        $data['title'] = 'Physis - Relatório Desempenho Sistema';
