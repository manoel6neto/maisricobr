...
while idFinal < 1000000:
	try:
		## Url para consulta ##
		url_consulta = str('http://convenios.physisbrasil.com.br/esicar/index.php/in/get_propostas/get_propostas_siconv?id_inicial=' + str(idInicial) + '&id_final=' + str(idFinal))	
