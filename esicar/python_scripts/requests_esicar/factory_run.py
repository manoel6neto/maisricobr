...
class myThread (threading.Thread):
	...
	def run(self):
		print "Chamada request esicar id_inicial: " + str(self.arg1) + " - id_final: " + str(self.arg2)
...
try:
	...
	db = MySQLdb.connect(host="localhost", user="root", passwd="Physis_2013", db="physis_esicar")
	cur = db.cursor()
