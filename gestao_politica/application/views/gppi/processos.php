...
<html lang="pt_BR">
    ...
    <head>
        ...
        <title>Gestão & Política - Gestão de Processos (GPPI)</title>
    ...
    <body>
        ...
        <div class="container py-5" style="margin-top: -30px;"> 
            ...
            <!-- Início Tabela de Gestão de Processos -->            

            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h6 class="panel-title">Gestão de Processos & Projetos - GPPI</h6>
                        </div>
                        ...
                        <div class="panel-body">                            
                            <div class="navbar navbar-main">
                                ...
                                <div class="navbar-buttons">
                                    <a href="<?php echo base_url("index.php/gppi/novo_projeto"); ?>"  alt="">
                                        <button type="button" class="btn btn-sm btn-primary"><b>+</b> Adicionar Projeto</button>
                                    </a>
                                </div>

                                <!-- Input Buscar por projeto -->
                                <div class="form-group nav-busca clearfix">
                                    <button type="button" class="btn btn-default btn-search">
                                        <i class="fa fa-search"></i>
                                    </button>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-large" placeholder="Buscar por projeto..." max="70" disabled="true">
                                ...
                                <div class="table-responsive">
                                    <div class="dataTables_wrapper" id="tabelaSimulacao_wrapper">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="ui-state-default" rowspan="1" colspan="1">
                                                        <div class="DataTables_sort_wrapper">Instituição<span class="DataTables_sort_icon css_right ui-icon ui-icon-triangle-1-n"></span>
                                                        </div>
                                                    </th>
                                                    <th class="ui-state-default" rowspan="1" colspan="1">
                                                        <div class="DataTables_sort_wrapper">Nome do programa<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
                                                        </div>
                                                    </th>
                                                    <th class="ui-state-default" rowspan="1" colspan="1">
                                                        <div class="DataTables_sort_wrapper">Vigência<span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s">                                                            
                                                            </span>
                                                        </div>
                                                    </th>
                                                    <th class="ui-state-default" rowspan="1" colspan="1">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="dataTables_info p-0" id="tabelaSimulacao_info">Mostrando de 1 até 10 de <?php echo 0; ?> registros</div>
