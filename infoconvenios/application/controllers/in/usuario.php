...
class Usuario extends BaseController {
    ...
    function proposta_aberta() {
        ...
        $data['title'] = 'Info Convênios - gerenciamento de propostas';
    ...
    function endereco() {
        ...
        if ($this->input->get_post('UF', TRUE) !== false) {
            ...
            $data['title'] = 'Info Convênios - gerenciamento de usuários';
        ...
        if ($this->input->get_post('login', TRUE) !== false && $this->input->get_post('senha', TRUE) !== false) {
            ...
            if (count($txt1) > 0)
                ...
                if (count($txt2) > 0) {
                    ...
                    if ($nome == '') {
                        $this->alert("Verifique se o site do siconv se encontra no ar. Caso esteja, entre em contato com a Info Convênios.");
                        $this->voltaPagina();
                    }
            ...
            $data['id'] = $this->input->get_post('id', TRUE);
            $data['login'] = $this->login;
            $data['title'] = "Info Convênios - Finaliza Trabalho";
        ...
        if ($this->input->get_post('login', TRUE) !== false && $this->input->get_post('senha', TRUE) !== false) {
            ...
            if (count($txt1) > 0)
                ...
                if (count($txt2) > 0) {
                    ...
                    $data['title'] = "Info Convênios - Gerencia Usuários";
    ...
    function alterar_senha_master() {
        ...
        if ($this->input->get_post('senha', TRUE) !== false) {
            ...
            $data['title'] = 'Info Convênios - alterar senha';
...
//$this->obter_pagina_post($pagina, $fields, $fields_string);
    ...
    function adiciona_usuario_trabalho() {
        ...
        $this->load->model('usuario_model');
        $data['title'] = "Info Convênios - Adicionar Usuário";
    ...
    function incluir_proposta() {
        ...
        $data['bancos'] = $this->proposta_model->obter_bancos();
        $data['title'] = 'Info Convênios - Incluir Proposta';
        $data['login'] = $this->login;
        $data['areas'] = $this->trabalho_model->obter_areas();
        $data['main'] = 'gestor/incluir_proposta';
        $this->load->vars($data);
    ...
    function gerapdf_programas_emenda() {
        ...
        $tabela = "Info Convênios CONSULTORIA E ASSESSORIA SOLIDÁRIA <br>";
        $programa_atual = '';
    ...
    function gerapdf_programas() {
        ...
        $head = "<div style=\"position:relative;float:right;top:200px;right:0;color:white;background-color:red;width:80px;height:80px;margin:0\">
  		...
  		<h3 style=\"top:10;color:red;text-align:center;margin:0;padding-top:10;\">Info Convênios CONSULTORIA E ASSESSORIA SOLIDÁRIA</h3>
  		</div>";
  ...
  <tr>
    ...
    function gerapdf_programas2() {//##madruga: dexei essa função para testar, e futuramente fazer outra por cima dela.
        ...
        $mpdf->allow_charset_conversion = true;
        $mpdf->charset_in = 'UTF-8';
        $tabela = "Info Convênios CONSULTORIA E ASSESSORIA SOLIDÁRIA <br> Lista Por cidade:";
        $orgao_atual = '';
    ...
    function index() {
        ...
        $data['title'] = "Info Convênios - Usuário";
    ...
    function visualiza_proposta() {
        ...
        $data['bancos'] = $this->proposta_model->obter_bancos();
        $data['title'] = 'Info Convênios - Visualizar Proposta';
        $this->load->vars($data);
        $this->load->view('in/template_projeto');
    }
    ...
    function incluir_justificativa() {
        ...
        $data['texto_padrao'] = "O Município de [cidade] - [estado], está localizado na Mesorregião [mesorregiao], inserida na Microrregião [microrregiao]. Possui uma área territorial de [area] Km², com densidade demográfica de [densidade] (hab/Km²). Segundo dados estimados pelo IBGE ([ano_estimativa]), sua população residente é de [populacao] habitantes, com Índice de Desenvolvimento Humano Municipal - 2010 (IDHM 2010) de [idhm] e o PIB do município é de R$ [pib] a preços correntes, com uma renda per capita de R$ [renda].";
    ...
    function listar_metas() {
        ...
        if ($this->input->get_post('id', TRUE) !== false) {
            ...
            $data['id'] = $id;
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Listar Metas da proposta";
...
//         	}
            ...
            $data['meta'] = $meta;
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Incluir Meta";
            $data['main'] = 'in/meta';
            $data['login'] = $this->login;
            $this->load->view('in/template_projeto', $data);
        }
    ...
    function listar_etapas() {
        ...
        if ($this->input->get_post('meta', TRUE) !== false) {
            ...
            $data['id'] = $this->input->get_post('id', TRUE);
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Listar Etapas da Meta";
...
//         }
        ...
        if ($this->input->get_post('meta', TRUE) !== false && $this->input->get_post('etapa', TRUE) === false) {
            ...
            $data['id'] = $this->input->get_post('id', TRUE);
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Incluir Etapa da Meta";
            ...
            $data['id'] = $this->input->get_post('id', TRUE);
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Incluir Etapa";
            $data['main'] = 'in/incluir_etapa_da_meta';
            $data['login'] = $this->login;
            $this->load->view('in/template_projeto', $data);
        } else {
    ...
    function listar_cronograma() {
        ...
        if ($this->input->get_post('id', TRUE) !== false) {
            ...
            $data['id'] = $id;
            $data['title'] = "Info Convênios - Listar Crono Desembolso";
            $data['leitura_pessoa'] = false;
...
//         }
        ...
        if ($this->input->get_post('idProposta', TRUE) !== false) {
            ...
            $data['id'] = $id;
            $data['leitura_pessoa'] = false;
            $data['title'] = "Info Convênios - Incluir Crono Desembolso";
    ...
    function listar_obras() {
        ...
        if ($this->input->get_post('id', TRUE) !== false && $this->input->get_post('acao', TRUE) === false) {
            ...
            $data['id'] = $id;
            $data['title'] = "Info Convênios - Listar Obras";
    ...
    function visualiza_propostas() {
        ...
        $data['title'] = "Info Convênios - Visualiza propostas";
    ...
    function gerencia_proposta_usuario() {
        ...
        $data['login'] = $this->login;
        $data['title'] = "Info Convênios - Gerencia propostas";
...
//function to decrypt the string
    ...
    public function envia_email_suporte() {
        ...
        if ($this->input->get_post('assunto', TRUE) !== false && $this->input->get_post('mensagem', TRUE) !== false) {
			...
			$this->email->initialize($this->usuariomodel->inicializa_config_email("no-reply@info-convenios.com.br"));
            ...
            $this->email->to("no-reply@info-convenios.com.br");
        ...
        $data['title'] = "Info Convênios - Suporte";
    ...
    public function modelos_documentos() {
        ...
        $data['title'] = 'Info Convênios - Modelos de Documentos';
    ...
    public function novo_documento() {
        ...
        $data['title'] = 'Info Convênios - Novo Documento';
    ...
    public function consultar_parecer(){
		...
		if($this->input->get('id', TRUE) != false && $this->input->get('idProposta', TRUE) != false && $this->input->get('idParecer', TRUE) != false){
    		...
    		$data['title'] = "Info Convênios - Consulta Parecer";
    ...
    public function links_uteis(){
    	...
    	$data['title'] = "Info Convênios - Links Úteis";
    ...
    public function tutoriais(){
    	...
    	$data['title'] = "Info Convênios - Tutoriais";
    ...
    public function utilizacao_sistema_cliente(){
    	...
    	$data['title'] = "Info Convênios - Área do Vendedor";
    ...
    public function lista_sugestoes(){
    	...
    	$data['title'] = "Info Convênios - Sugestões";
    ...
    public function responde_sugestao(){
    	...
    	if($this->input->post(null, TRUE)){
    		...
    		if($this->form_validation->run()){
    			...
    			$this->sugestao_model->envia_email($usuario_admin->email, $usuario_admin->nome, $this->input->post('resposta_sugestao', TRUE), "Resposta de Sugestão Info Convênios", $usuario->email);
