...
class relatorio extends BaseController{
	...
	public function index(){
		...
		$data['title'] = 'Info Convênios - Relatórios';
	...
	public function rel_proj_desenv(){
		...
		$data['title'] = 'Info Convênios - Relatório Projetos Desenvolvidos';
	...
	public function rel_atividade_usuario(){
		...
		$data['title'] = 'Info Convênios - Relatório Atividade Usuário';
	...
	public function rel_desempenho_sistema(){
		...
		$data['title'] = 'Info Convênios - Relatório Desempenho Sistema';
