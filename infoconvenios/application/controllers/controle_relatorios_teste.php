...
class controle_relatorios_teste extends BaseController {
    ...
    public function index() {
        ...
        $data['title'] = 'Info Convênios - Relatório Nacional de Propostas e Programas';
        $data['main'] = "relatorios_estatisticos/gera_relatorio_teste";
    ...
    public function busca_municipios() {
        ...
        if (!empty($municipios)) {
            foreach ($municipios as $municipio) {
                $options .= "<option value='{$municipio->municipio}'>{$municipio->municipio}</option>";
            }
        }
