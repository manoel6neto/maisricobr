                                                                                                    ...
                                                                                                    <div class="col-md-4 pull-right">
                                                                                                        <div class="pull-right">
                                                                                                                ...
                                                                                                                <?php if($this->session->userdata('nivel') == 1):?>
                                                                                                                    <a onclick="return confirm('Tem certeza que deseja ativar essa proposta padrão?')" alt="Ativar padrão" title="Ativar padrão"
                                                                                                                    class="btn btn-sm btn-default" href="<?php echo base_url(); ?>index.php/in/usuario/duplica_trabalho_ativa_padrao?id=<?php echo $proposta->idProposta; ?>">
                                                                                                                            <i class="fa fa-file-o"></i>
                                                                                                                    </a>
                                                                                                                <?php endif;?>
