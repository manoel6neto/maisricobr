<div class="login spacing-x2">
	<div class="col-md-8 col-sm-6 col-sm-offset-2">
            <div style="background-color: white; border-top: solid #D8D8D8; border-bottom: solid #3a7ec0; border-left: solid #D8D8D8; border-right: solid #D8D8D8; border-width: thin; border-bottom-color: #3a7ec0">
                <img src="<?php echo base_url(); ?>layout/assets/images/cabecalho_compra.png" style="width: 95%; height: 95%; padding-left: 4.3%;"/>
            </div>
						...
						<td style="border: solid #808080; border-width: thin; margin-top: 20px;">
                                                    <fieldset style="margin-top: 15px;">
                                                            <legend>
                                                                ...
                                                                <h6 style="text-align: center;">Crie uma conta no Info Convênios</h6>
                                                            </legend>
