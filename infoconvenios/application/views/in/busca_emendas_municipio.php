...
<!--                                                                                <div class="col-sm-8">
									...
									<div class="form-group col-md-10">
										...
										<input type="checkbox"
											...
											<div class="">
												<?php
												if(!empty($cnpjs))
													echo "<input type='checkbox' disabled='true' checked='checked' class='cnpj_todos'> <span style='color:#428bca;'><b>Selecionar Todos</b></span>"; 
												?>
												<?php $lista_cnpjs = array();?>
												<?php foreach ($cnpjs as $cnpj){?>
													<label> 
                                                                                                            <input type="checkbox" class="cnpj" disabled='true' name="cnpj[]" checked="checked" value="<?php echo $cnpj->cnpj;?>"> <?php $lista_cnpjs[] = $cnpj->cnpj;?>
									...
									<div class="form-group">
										...
										<?php if($lista_entidades['municipal']): ?>
                                                                                    <label class="checkbox"> <input type="checkbox"
                                                                                            class="obrigaAtende" id="prop1municipal" name="atende[]" <?php if($lista_entidades['municipal']){?>checked="checked" disabled="true"<?php }?>
										...
										<?php if($lista_entidades['estadual']): ?>
                                                                                    <label class="checkbox"> <input type="checkbox"
                                                                                            class="obrigaAtende" id="prop1estadual" name="atende[]" <?php if($lista_entidades['estadual']){?>checked="checked" disabled="true"<?php }?>
                                                                                ...
                                                                                <?php if($lista_entidades['privada']): ?>            
                                                                                    <label class="checkbox"> <input type="checkbox"
                                                                                           class="obrigaAtende" id="prop1entidade" name="atende[]" <?php if($lista_entidades['privada']){?>checked="checked" disabled="true"<?php }?>
                                                                                ...
                                                                                <?php if($lista_entidades['eco_mista']): ?>            
                                                                                    <label class="checkbox"> <input type="checkbox"
                                                                                            class="obrigaAtende" id="prop1entidade" name="atende[]" <?php if($lista_entidades['eco_mista']){?>checked="checked" disabled="true"<?php }?>
                                                                                ...
                                                                                <?php if($lista_entidades['consorcio']): ?>            
                                                                                    <label class="checkbox"> <input type="checkbox"
                                                                                            class="obrigaAtende" id="prop1consorcio" name="atende[]" <?php if($lista_entidades['consorcio']){?>checked="checked" disabled="true"<?php }?>
	...
	<h1 class="bg-white" style="text-align: right;">
		...
		<input type="hidden" id="num_prog" value="<?php echo $num_rows; ?>">
                <?php if(isset($num_emendas_parl)): ?>
                    <span class="num_prog" style="font-size: 22px;">EMENDA PARLAMENTAR(S): <?php echo $num_emendas_parl; ?></span><br>
                <?php endif; ?>
                <?php if(isset($num_emendas_especifica)): ?>
                    <span class="num_prog" style="font-size: 22px;">ESP. CONCEDENTE: <?php echo $num_emendas_especifica; ?></span><br>
                <?php endif; ?>
	</h1>
