                            ...
                            <?php endif;?>	
                                    ...
                                    <hr style="border: 1px solid lightgray;">
                                            <?php if($this->session->userdata('nivel') == 4):?>
                                                    <li><a id="ocultaMenu" style="cursor: pointer;" title="Menu do Vendedor"><i id="icone-menu-vendedor" class="fa fa-arrow-circle-<?php if($this->session->userdata("escondeMenu") == "S") { echo "down"; }else{echo "up";}?>"></i></a></li>
                                            <?php endif;?>
                                    <?php endif;?>
...
<!--			<div style="position: absolute; bottom: 20px; width: 100%; text-align: center;">
				<img src="<?php echo base_url()?>layout/assets/images/logo_physis1.png" width="200" height="35">
			</div>-->
		</div>
	</div>
</div>
...
$(document).ready(function(){
	$('.dropdown.keep-open').on({
	    "shown.bs.dropdown": function() { this.closeable = false; },
	    "click":             function() { this.closeable = true; },
	    "hide.bs.dropdown":  function() { return this.closeable; }
	});
