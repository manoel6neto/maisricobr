...
<div class="col-md-12 bg-white innerAll spacing-x2">
	...
	<table class="table">
		...
		<tr>
			<td><?php if (isset($proposta)!== false) echo implode("/", array_reverse(explode( "-", $proposta->data))); else echo date ( "d/m/Y" );?></td>
	...
	<table class="table">
		<tr>
			<td>Justificativa</td>
			<td><?php if(isset($justificativa)!== false AND $justificativa!= null AND count($justificativa) > 0) echo $justificativa->Justificativa; else echo "Não cadastrado";?></td>
		</tr>
		<tr>
			<td>Objeto</td>
			<td><?php if(isset($justificativa)!== false AND $justificativa!= null AND count($justificativa) > 0) echo $justificativa->objeto; else echo "Não cadastrado";?></td>
		</tr>
	</table>
	...
	<table class="table">
		...
		<tbody>
            <tr>
				...
				<td style="width: 50%"><?php if (isset($meta) !== false AND $meta != null AND count($meta) > 0) echo $meta['especificacao']; else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($meta) !== false AND $meta != null AND count($meta) > 0) echo $meta['total']; else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($meta) !== false AND $meta != null AND count($meta) > 0) echo implode("/", array_reverse(explode("-", $meta['data_inicio']))); else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($meta) !== false AND $meta != null AND count($meta) > 0) echo implode("/", array_reverse(explode("-", $meta['data_termino']))); else echo "Não cadastrado"; ?></td>
			</tr>
		</tbody>
	</table>
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td style="width: 47%"><?php if (isset($etapa) !== false AND $etapa != null AND count($etapa) > 0) echo $etapa['especificacao']; else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($etapa) !== false AND $etapa != null AND count($etapa) > 0) echo $etapa['total']; else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($etapa) !== false AND $etapa != null AND count($etapa) > 0) echo implode("/", array_reverse(explode("-", $etapa['data_inicio']))); else echo "Não cadastrado"; ?></td>
				<td><?php if (isset($etapa) !== false AND $etapa != null AND count($etapa) > 0) echo implode("/", array_reverse(explode("-", $etapa['data_termino']))); else echo "Não cadastrado"; ?></td>
			</tr>
    		<?php } ?>
    	</tbody>
	</table>
<?php } ?>
		...
		<table class="table bg-white">
			...
			<tbody>
				<tr>
					...
					<td style="width: 25%"><?php if (isset($crono) !== false AND $crono != null AND count($crono) > 0) echo $crono['responsavel']; else echo "Não cadastrado"; ?></td>
					<td style="width: 25%"><?php if (isset($crono) !== false AND $crono != null AND count($crono) > 0) echo $crono['parcela']; else echo "Não cadastrado"; ?></td>
					<td><?php if (isset($crono) !== false AND $crono != null AND count($crono) > 0) echo $crono['mes'] . "/" . $crono['ano']; else echo "Não cadastrado"; ?></td>
				</tr>
			</tbody>
		</table>
		...
		<table class="table bg-white">
			...
			<tbody>
				...
				<tr>
					<td><?php if (isset($bem) !== false AND $bem != null AND count($bem) > 0) echo $bem->descricao; else echo "Não cadastrado"; ?></td>
					<td><?php if (isset($bem) !== false AND $bem != null AND count($bem) > 0) echo number_format($bem->total, 2, ",", "."); else echo "Não cadastrado"; ?></td>
				</tr>
				<?php endforeach;?>
			</tbody>
		</table>
