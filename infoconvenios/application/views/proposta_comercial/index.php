<div id="content" class="innerAll bg-white">
	...
	<a class="btn btn-info" target="_blank" onclick="location.href='<?php echo base_url('arquivos_download/minuta_edital_pregao.docx'); ?>'"><i class="fa fa-download"></i> Minuta Edital</a>
                    ...
                    <table class="table">
                    	...
                    	<?php foreach ($proposta_cadastradas as $p):?>
                    		<tr>
	                    		...
	                    		<td><?php echo number_format(($p->valor_proposta_comercial*((100-$p->percentual_desconto)/100)), 2, ",", "."); ?></td>
...
<div id="dialog-form" title="Enviar Proposta Comercial" style="visibility: collapse;">
  <form>
    <fieldset>
      ...
      <input type="text" name="assunto" size="40" id="assunto" value="Proposta Comercial Sistema Info Convênios" class="text ui-widget-content ui-corner-all" style="color: black;"><br>
      <label for="mensagem">Mensagem</label><br>
      <textarea name="mensagem" id="mensagem" rows="8" cols="50" class="text ui-widget-content ui-corner-all">Segue a proposta comercial de utilização do sistema Info Convênios.</textarea><br>
