...
<?php
// if ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 2 || $this->session->userdata('nivel') == 4) 
	$this->load->view('controle_usuarios/sidebar_usuarios');
// else
// 	$this->load->view('in/sidebar2');
?> 
