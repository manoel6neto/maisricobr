...
<div class="login spacing-x2">
	<div class="col-md-4 col-sm-6 col-sm-offset-4">
		...
		<div class="innerAll text-center"><img src="<?php echo base_url(); ?>layout/assets/images/logo_topo.png" width="100%" height="100%"/></div>
...
// 	});
		...
		$.ajax({
			...
			success:function(data){
				if(data > 0)
					...
					$("#"+msgRetorno).html("<i class='btn-sm btn-primary fa fa-warning' style='background-color: red'></i>");
			}
		});
	}
	...
	$("#exampleInputEmail1").blur(function(){
		if($(this).val() != "")
			...
			$("#retornoLogin").html("<i class='btn-sm btn-primary fa fa-warning' style='background-color: red'></i>");
	});
