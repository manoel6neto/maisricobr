<div id="content" class="bg-white">
    <h1 class="bg-white content-heading border-bottom">Relatório Nacional de Propostas e Programas</h1>
    
    <div class="bg-white innerAll col-md-3">
	    <form action="<?php echo base_url('index.php/controle_relatorios_teste/gera_estatistica'); ?>" target="_blank" method="post">
