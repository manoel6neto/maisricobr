...
/**
	* Alterado para nï¿½o dar erro caso o campo nï¿½o exista na tela.
	*
...
/**
    ...
    function isValidDate(day, month, year) {
    	...
    	// Pega o ano atual para verificar se a data é maior que 30 anos futuros
		var d = new Date();
		var year_now = d.getFullYear();
				
		if(year < 1900 || year > year_now + 30) {
			return false;
		}
