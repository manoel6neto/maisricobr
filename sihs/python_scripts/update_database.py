...
comando = 'mysql -uroot -pPhysis_2013 --default-character-set=utf8 physis_sihs < ' + caminho + ' ' + script
...
subject = 'Executado script para update de visoes physis sihs!! CODIGO DE RETORNO: ' + codigo_saida
