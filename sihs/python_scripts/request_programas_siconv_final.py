...
url_consulta = str('http://secretaria.physisbrasil.com.br/sihs/index.php/get_programas/get_ids_programas?ano=2016')
...
url_consulta = str('http://secretaria.physisbrasil.com.br/sihs/index.php/get_programas/retorna_num_ids?ano=2016')
response = requests.get(url_consulta)
if response.status_code == 200:
...
if num_registros > 0:
	while offset <= num_registros:
		try:
			url_consulta = str('http://secretaria.physisbrasil.com.br/sihs/index.php/get_programas/get_programas_siconv?ano=2016&offset='  + str(offset))
			response = requests.get(url_consulta)
			if response.status_code == 200:
				offset = offset + 1
