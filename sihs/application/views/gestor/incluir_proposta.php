...
<div class="col-md-8 bg-white">
		...
		<select name="banco" class="form-control obrigatorio col-xs-3" id="cadastrarPropostaBanco">
				<option value="">Selecione</option>
                <?php foreach ($bancos as $banco){ echo "<option value=\"{$banco->idbanco}\""; if ((isset($proposta->banco) !==false && $banco->idbanco == $proposta->banco) || $banco->idbanco == 1002) echo "selected=\"true\""; echo ">".$banco->nome."</option>"; } ?>
         </select>
