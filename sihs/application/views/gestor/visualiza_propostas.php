...
<script type="text/javascript">
    function buscaProposta(idPropostaSiconv) {
        //localhost/sihs/sihs/index.php/in/get_propostas/get_propostas_siconv?id_inicial=507964&id_final=507964
        $.ajax({
    ...
    <?php $i = 0; ?>
                                ...
                                <?php foreach ($cnpjs as $cidade): ?>
                                    ...
                                    foreach ($propostas_cadastradasAux as $proposta) {
                                        if ($proposta->proponente == $cidade->cnpj) {
            ...
            <?php echo $proponente_siconv_model->busca_nome_proponente($cidade->cnpj); ?><span style="color: red; font-size: 16px;"><?php echo " ({$qtd})"; ?></span>
                                                </a>
                                                    <?php if ($temAlerta): ?>
        ...
        <?php foreach ($propostas_cadastradas as $proposta): ?>
                                                        <?php if ($proposta->proponente == $cidade->cnpj): ?>
                                                            <!-- Inicio dos dados -->
                ...
                <?php endif; ?>
                                                                                ...
                                                                                <?php if ($permissoes->tornar_proj_padrao): ?>
                                                                                    ...
                                                                                    <a onclick="return confirm('Tem certeza que deseja tornar essa proposta em padrão?')" alt="Tornar padrão" title="Tornar padrão"
                                                                                       class="btn btn-sm btn-<?php echo $tipoBotao; ?>" href="<?php echo base_url(); ?>index.php/in/usuario/duplica_trabalho_torna_padrao?id=<?php echo $proposta->idProposta; ?>">
                ...
                <?php endif; ?>
                                                                                ...
                                                                                <?php if ($permissoes->alterar_end_projeto): ?>
                                                                                    <a alt="Altera Endereço" title="Altera Endereço" class="btn btn-sm btn-default"
                ...
                <?php endif; ?>
                                                                                ...
                                                                                <?php if ($permissoes->editar_projeto): ?>
                                                                                    <a alt="Editar Proposta" title="Editar Proposta" class="btn btn-sm btn-default"
                ...
                <?php endif; ?>
                                                                                <a alt="Relatorio Proposta" title="Relatorio Proposta"
                                                                                   class="btn btn-sm btn-success" target="__blank" href="<?php echo base_url(); ?>index.php/in/usuario/imprimir_extrato?id=<?php echo $proposta->idProposta; ?>">
                                                                                    <i class="fa fa-file-o"></i>
                                                                                </a>
                                                                            </div>
                                                                        </div>
