...
<table>
	<tbody><tr>
		<td colspan="3" class="subtitulo">&nbsp;&nbsp;&nbsp;Dados da Meta</td>
	</tr>
</tbody></table>
...
<input type="hidden" name="idMeta" value="<?php if (isset($meta->idMeta) !== false) echo $meta->idMeta;?>">
	<table>
		<tbody onKeyDown="return altera_botao(event)">
				<tr id="tr-incluirEspecificacao" class="especificacao">
					<td class="label"><nobr>Especificação
					<div class="important">*</div>
					</nobr></td>
					<td class="field">
					<textarea class='obrigatorio' id="especificacao" onkeyup="verifica();textCounter(this.form.especificacao,this.form.remLen,5000);" onchange="textCounter(this.form.especificacao,this.form.remLen,5000);" onkeydown="textCounter(this.form.especificacao,this.form.remLen,5000);" rows="5" cols="60" size="5000" onkeypress="keySubmit(event)" onmouseup="verifica();" style="width:500" onmouseout="hints.hide()" onmouseover="hints.show('cadastrar.meta.crono.fisico.meta.incluir.param.especificacao.title')" name="especificacao">
<?php if (isset($meta->especificacao) !== false) echo $meta->especificacao;?></textarea>
					<div id="caracteresRestantes"> Caracteres restantes: <input type="text" value="5000" maxlength="4" size="4" name="remLen" readonly=""></div>	
					</td>
				</tr>
			 <tr id="tr-incluirCodUnidadeFornecimento" class="codUnidadeFornecimento">
                        <td class="label"><nobr>Unidade Fornecimento <div class="important">*</div></nobr></td>
                         <td class="field">
                           <input class='obrigatorio' type="text" value="<?php if (isset($meta->fornecimento) !== false) echo $meta->fornecimento;?>" id="fornecimento" onmouseout="hints.hide()" onmouseover="hints.show('cadastrar.meta.crono.fisico.meta.incluir.param.cod.unidade.fornecimento.title')" onkeypress="keySubmit(event)" onkeyup="verifica()" onmouseup="verifica()" name="fornecimento" size="9">
                        	<select name="uf_nome" id="uf_nome" onchange="transferir_uf()">
						<option value=""></option>
						<?php
							foreach ($ufs as $uf) {
	        	...
	        	<tr id="tr-incluirValor" class="valor">
                	<td class="label"><nobr>
                		Valor Total (R$)
                		<div class="important">*</div></nobr></td>
                    <td class="field">
	                    
				        <input class='obrigatorio' type="text" value="<?php if (isset($meta->total) !== false) echo number_format($meta->total,2,",",".");?>" onkeydown="backspace(this,event)" onblur="calculaValorUnitario(valorUnitario,quantidade.value,valor.value)" onkeypress="reais(this,event)" id="total" onmouseout="hints.hide()" onmouseover="hints.show('cadastrar.meta.crono.fisico.meta.incluir.param.valor.title')" onkeyup="verifica()" onmouseup="verifica()" name="valor">
		            </td>
        	    </tr>
	                       <tr id="tr-incluirQuantidade" class="quantidade">
                        		<td class="label"><nobr>Quantidade
                        		<div class="important">*</div></nobr></td>
                        		<td class="field">
						
						<input class='obrigatorio' type="text" value="<?php if (isset($meta->quantidade) !== false) echo number_format($meta->quantidade,2,",",".");?>" onkeydown="backspace(this,event)" onblur="calculaValorUnitario(valorUnitario,quantidade.value,valor.value)" onkeypress="reais(this,event)" id="incluirQuantidade" onmouseout="hints.hide()" onmouseover="hints.show('cadastrar.meta.crono.fisico.meta.incluir.param.quantidade.title')" onkeyup="verifica()" onmouseup="verifica()"  name="quantidade">
		                        </td>
				</tr>
			
	        	<tr id="tr-incluirValorUnitario" class="valorUnitario">
                	<td class="label"><nobr>Valor Unitário (R$) 
                			</nobr></td>
                    <td class="field">
				        <input class='obrigatorio' type="text" value="<?php if (isset($meta->valorUnitario) !== false) echo number_format($meta->valorUnitario,2,",",".");?>" onkeydown="backspace(this,event)" onkeypress="reais(this,event)" id="incluirValorUnitario" readonly="readonly" onmouseout="hints.hide()" onmouseover="hints.show('cadastrar.meta.crono.fisico.meta.incluir.param.valor.unitario.title')" onkeyup="verifica()" onmouseup="verifica()" name="valorUnitario">
	                </td>
    	        </tr>
				<tr id="tr-incluirDataInicio" class="dataInicio">
					<td class="label"><nobr>Data de Início
					<div class="important">*</div>
					</nobr></td>
					<td class="field">
					<input class='obrigatorio' type="text" OnKeyUp="mascaraData(this);" value="<?php if (isset($meta->data_inicio) !== false) echo implode("/",array_reverse(explode("-",$meta->data_inicio)));?>" id="data_inicio" maxlength="10" name="data_inicio">
					</td>
				</tr>
				<tr id="tr-incluirDataFim" class="dataFim">
					<td class="label"><nobr>Data de Término
					<div class="important">*</div>
					</nobr></td>
					<td class="field"> <input class='obrigatorio' type="text" OnKeyUp="mascaraData(this);" value="<?php if (isset($meta->data_termino) !== false) echo implode("/",array_reverse(explode("-",$meta->data_termino)));?>" id="data_termino" maxlength="10" name="data_termino">
					</td>
				</tr>
...
<option <?php if ((isset($meta->UF) !== false) && ($meta->UF) == '26') echo "selected=\"true\"";?> value="26">TO</option></select>
				...
				<tr id="tr-cadastrarParticipeCodigoMunicipio" class="codigoMunicipio">
					...
					<td class="field">
					 <input type="text" value="<?php if (isset($meta->municipio_sigla) !== false) echo $meta->municipio_sigla;?>" id="municipio_sigla" maxlength="5" size="5" name="municipio_sigla">
...
<br /><input class="buttonLink" type="button" value="Voltar" onclick="location.href='<?= base_url();?>index.php/in/usuario/listar_metas?id=<?= $id;?>&edita_gestor=<?= $edita_gestor?>';">
<?php if (isset($meta->idMeta) !== false) {?>
	<a class="buttonLink" href="<?= base_url();?>index.php/in/usuario/incluir_etapa_da_meta?meta=<?= $meta->idMeta ?>&id=<?= $id;?>&edita_gestor=<?= $edita_gestor?>">Inserir Etapa</a>
<?php } ?>
</div>
</div>
<br class="clr">
