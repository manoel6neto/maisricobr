                ...
                <div id="collapse-1-1" class="panel-collapse collapse">
                    <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="data_inicio" id="Data1" maxlength="10" <?php if ($filtro == null || isset($filtro['vigencia'])) { ?>disabled="disabled"<?php } ?> class="form-control ie" OnKeyUp="mascaraData(this);" value="<?php
                                        ...
                                        <div class="col-sm-10">
                                            <input name="data_fim" class="form-control ie" maxlength="10" <?php if ($filtro == null || isset($filtro['vigencia'])) { ?>disabled="disabled"<?php } ?> id="Data2" OnKeyUp="mascaraData(this);" value="<?php
                                ...
                                <div class="col-md-4">
                                    <div class="form-group col-md-10">
                                        ...
                                        <label class="checkbox"> 
                                            <input type="checkbox"
                                                   id="prop1voluntaria" class="obrigaQualificacao" name="qualificacao[]" <?php if (($filtro == null || in_array("Proposta Voluntária", $filtro['qualificacao'])) || ($usuario_parlamentar)) { ?>checked="checked"<?php } ?>
                                        ...
                                        <label class="checkbox"> 
                                            <input type="checkbox" 
                                                   id="prop1especifico" class="obrigaQualificacao" name="qualificacao[]" <?php
                                                   if ((isset($filtro) && in_array("Proposta de Proponente Específico do Concedente", $filtro['qualificacao']))) {
                                                       echo 'checked="checked"';
                                                   }
                                                   ?>
                                                   value="Proposta de Proponente Específico do Concedente" 
                                                   onclick="selecionarCima('prop')"> 
                                            <b>Proposta de Proponente Específico do Concedente</b>
                                        </label> 
                                        <label class="checkbox"> 
                                            <input type="checkbox"
                                                   id="prop1emenda" class="obrigaQualificacao" name="qualificacao[]" <?php if ((isset($filtro) && in_array("Proposta de Proponente de Emenda Parlamentar", $filtro['qualificacao']))) { ?>checked="checked"<?php } ?> 
                                                   value="Proposta de Proponente de Emenda Parlamentar"
                                                   onclick="selecionarCima('prop')"> 
                                            <b>Proposta de Proponente de Emenda Parlamentar</b>
                                        </label>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="checkbox"> <input type="checkbox"
                                                                        class="obrigaAtende" id="prop1municipal" name="atende[]" <?php if (($usuario_parlamentar && !isset($filtro['atende'])) || (isset($lista_entidades) && $lista_entidades['municipal'] && !isset($filtro['atende'])) || (isset($filtro['atende']) && in_array("Administração Pública Municipal", $filtro['atende']))) { ?>checked="checked"<?php } ?>
                                        ...
                                        <?php if ($this->session->userdata('nivel') == 9 || ($this->session->userdata('sistema') != "M" || ($this->session->userdata('nivel') == 1 || $this->session->userdata('nivel') == 4))): ?>
                                            <label class="checkbox"> <input type="checkbox"
                                                ...
                                                <b>Estadual</b>
                                                                                     ...
                                                                                     class="obrigaAtende" id="prop1entidade" name="atende[]" <?php if (($usuario_parlamentar && !isset($filtro['atende'])) || (isset($lista_entidades) && $lista_entidades['privada'] && !isset($filtro['atende'])) || (isset($filtro['atende']) && in_array("Organização da Sociedade Civil", $filtro['atende']))) { ?>checked="checked"<?php } ?>
                                                                                     value="Organização da Sociedade Civil" > 
                                                <b>Organização da Sociedade Civil</b>
                                            </label> 
                                        </label> <label class="checkbox"> <input type="checkbox"
                                                                                 class="obrigaAtende" id="prop1entidade" name="atende[]" <?php if (($usuario_parlamentar && !isset($filtro['atende'])) || (isset($lista_entidades) && $lista_entidades['eco_mista'] && !isset($filtro['atende'])) || (isset($filtro['atende']) && in_array("Empresa pública/Sociedade de economia mista", $filtro['atende']))) { ?>checked="checked"<?php } ?>
                                ...
                                <label class="checkbox"> <input type="checkbox"
                                                                class="obrigaAtende" id="prop1consorcio" name="atende[]" <?php if (($usuario_parlamentar && !isset($filtro['atende'])) || (isset($lista_entidades) && $lista_entidades['consorcio'] && !isset($filtro['atende'])) || (isset($filtro['atende']) && in_array("Consórcio Público", $filtro['atende']))) { ?>checked="checked"<?php } ?>
                        ...
                        <div class="col-md-4" style="margin-bottom: 10px; margin-left: 10px;">
                            <div class="form-group">
                                <label for="cod_estados" style="color: red;">Busca por termos-chave:</label><p>

                                    <input type='checkbox' class='chave_todos'> <span style='color:#428bca;'><b>Selecionar Todos</b></span>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveAbastecimentoAgua" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Abastecimento de Água", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Abastecimento de Água" > 
                                        <b>Abastecimento de Água</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveSaneamentoBasico" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Saneamento Básico", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Saneamento Básico" > 
                                        <b>Saneamento Básico</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveResiduosSolidos" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Resíduos Sólidos", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Resíduos Sólidos" > 
                                        <b>Resíduos Sólidos</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveRecursosHidricos" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Recursos Hídricos", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Recursos Hídricos" > 
                                        <b>Recursos Hídricos</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveSaude" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Saúde", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Saúde" > 
                                        <b>Saúde</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveTurismo" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Turismo", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Turismo" > 
                                        <b>Turismo</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveSustentabilidade" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Sustentabilidade", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Sustentabilidade" > 
                                        <b>Sustentabilidade</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveEducacaoAmbiental" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Educação Ambiental", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Educação Ambiental" > 
                                        <b>Educação Ambiental</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveComunidadesTradicionais" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Comunidades Tradicionais", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Comunidades Tradicionais" > 
                                        <b>Comunidades Tradicionais</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveAssentamentos" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Assentamentos", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Assentamentos" > 
                                        <b>Assentamentos</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveAgriculturaFamiliar" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Agricultura Familiar", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Agricultura Familiar" > 
                                        <b>Agricultura Familiar</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveIrrigacao" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Irrigação", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Irrigação" > 
                                        <b>Irrigação</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveSegurancaHidrica" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Segurança Hídrica", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Segurança Hídrica" > 
                                        <b>Segurança Hídrica</b>
                                    </label>

                                    <label class="checkbox"> <input type="checkbox"
                                                                    class="obrigaChave" id="chaveSegurancaDeBarragem" name="chave[]" <?php if (isset($filtro['chave']) && in_array("Segurança de Barragem", $filtro['chave'])) { ?>checked="checked"<?php } ?>
                                                                    value="Segurança de Barragem" > 
                                        <b>Segurança de Barragem</b>
                                    </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input type="checkbox" name="mostra_ocultos" value="1" <?php
                            if (isset($filtro['mostra_ocultos']) && $filtro['mostra_ocultos'] == 1) {
                                echo "checked='checked'";
                            }
                            ?>> 
...
<?php if (isset($lista) AND $lista != null) { ?>
    <h1 class="bg-white" style="text-align: right;">
        ...
        <span>EXIBIDOS: <span class="num_prog" style="font-size: 22px;"><?php echo $num_rows; ?></span> TOTAL: <?php
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="pull-left">
                                ...
                                <img src="<?php echo base_url(); ?>layout/assets/images/loader.gif" style="width: 30px;" id="<?php echo explode('&path', explode('?id=', $programa->link)[1])[0]; ?>" class="loader">
                                <a class="btn btn-sm btn-info atualizaPrograma" title="Atualizar Programa" id="<?php echo explode('&path', explode('?id=', $programa->link)[1])[0]; ?>"><i class="fa fa-refresh"></i></a>
                            </div>
                            <br><br>
                            <ul class="media-list">
                                <li class="media">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".atualizaPrograma").click(function () {
            $(".loader").show();
            var idPrograma = $(this).attr('id');
            var urlParecer = '<?php echo base_url() . 'index.php/get_programas/update_programas_siconv?id_programa=' ?>' + idPrograma;
            $.ajax({
                url: urlParecer,
                type: 'get',
                dataType: 'html',
                success: function (data) {
                    $(".loader").hide();
                    location.href = "<?php echo base_url() . 'index.php/in/dados_siconv/busca_programas' ?>";
                }
            });
            return false;
        });
    ...
    $(".chave_todos").click(function () {
        $(".obrigaChave").each(function () {
            $(this).attr("checked", $(".chave_todos").is(":checked"));
        });
    });

    $(".obrigaChave").click(function () {
        $(".chave_todos").attr("checked", false);
    });
