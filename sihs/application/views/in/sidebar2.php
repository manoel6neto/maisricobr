...
switch ($this->session->userdata('pagAtual')) {
    ...
    case "visualiza_propostas_pareceres":
        ...
        break;
    case "visualiza_propostas_pareceres_geral":
        $activePropParecGeral = "active";
        break;
    case "busca_emendas":
        ...
        <div class="sidebarMenuWrapper" style="top: 0px;">
            <?php if (($this->session->userdata('sistema') == 'M' || $this->session->userdata('sistema') == 'E') || ($this->session->userdata('nivel_gestor') != null && $this->session->userdata('nivel_gestor') == 'C') || $this->session->userdata('nivel') == 1): ?>
                <ul class="list-unstyled">
                    ...
                    <?php if ($this->session->userdata('nivel') == 1): ?>
                        ...
                        <li class="<?php echo $activePropParec; ?>"><a href="<?= base_url(); ?>index.php/in/dados_siconv/visualiza_propostas_pareceres"><span><i class="fa fa-retweet"></i> Propostas SICONV</span></a></li>
                    ...
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            <?php if ($permissoes->visualiza_emendas): ?>
                                <li class="<?php echo $activeBuscaEmendasGeral; ?>"><a href="<?= base_url(); ?>index.php/in/dados_siconv/busca_emendas_municipio"><span><i class="fa fa-file-text"></i> Emendas Disponíveis
                                        </span></a></li>
                            <?php endif; ?>
                            <?php if ($permissoes->visualiza_prop_parecer): ?>
                                <li class="<?php echo $activePropParec; ?>"><a href="<?= base_url(); ?>index.php/in/dados_siconv/visualiza_propostas_pareceres"><span><i class="fa fa-retweet"></i> Propostas e Pareceres - SIHS</span></a></li>
                                <li class="<?php echo $activePropParecGeral; ?>"><a href="<?= base_url(); ?>index.php/in/dados_siconv/visualiza_propostas_pareceres?geral=1"><span><i class="fa fa-retweet"></i> Propostas SICONV</span></a></li>
                                <!--<li class="<?php echo $activeImportSiconv; ?>"><a href="<?= base_url(); ?>index.php/in/get_propostas/import_from_siconv_to_esicar"><span><i class="fa fa-download"></i> Importar do Siconv</span></a></li>-->
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <li class="<?php echo $activeRelatorio; ?>"><a href="<?= base_url(); ?>index.php/export/gerar_export"><span><i class="fa fa-download"></i> Exportar Dados</span></a></li>
                    ...
                    <?php endif; ?>
                                ...
                                <?php if ($this->session->userdata('nivel') == 4): ?>
                        <li id="ocultaAreaVendedor" class="<?php echo $activeAreaVendedor; ?>"><a href="<?= base_url(); ?>index.php/controle_usuarios/area_vendedor"><span><i class="fa fa-user"></i> Área Representante
            ...
            <ul class="list-unstyled">
                <?php if ($this->session->userdata('nivel') == 1 || ($this->session->userdata('nivel') == 2 && $this->session->userdata('tipo_gestor') != 10)  || $this->session->userdata('nivel') == 4 || $this->session->userdata('nivel') == 6) { ?>
                    <li><a href = "<?php echo base_url(); ?>index.php/controle_usuarios" title="Área do Cliente" class = "menu-icon"><i class = "fa fa-user"></i> Área do cliente</a></li>
                <?php } else { ?>
                    <li><a href = "<?php echo base_url(); ?>index.php/controle_usuarios/atualiza_usuario?id=<?php echo $this->session->userdata('id_usuario'); ?>" class = "menu-icon"><i class = "fa fa-user"></i> Área do cliente</a></li>
                <?php } ?>
            </ul>
            <ul class="list-unstyled">
                <li>
                    <a href="<?php echo base_url(); ?>index.php/in/login/sair" class="menu-icon"><span><i class="fa fa-power-off"></i> Sair</span></a>
                </li>
            </ul>

            <div>
                <img src="<?php echo base_url(); ?>layout/assets/images/brasao.jpg" width="60%" height="40%" style="alignment-adjust: central; margin-left: 20%; margin-top: 20px; margin-bottom: 40px;"/>
            </div>
        </div>
