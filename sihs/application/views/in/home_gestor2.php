...
<div class="innerAll spacing-x2">
	<div class="row">
		<?php if($permissoes->consultar_programa || ($this->session->userdata('sistema') == 'P' && $this->session->userdata('nivel_gestor') != null && $this->session->userdata('nivel_gestor') == 'C')):?>
				...
				<div class="front">
					...
					<div class="widget text-center widget-scroll" data-scroll-height="50%">
						<div class="widget-body padding-none" style="box-shadow: 10px 10px 5px #888888;">
							<div>
								<div class="innerAll" style="background-color: #cb4040;">
									<p class="lead text-white strong margin-none" style="font-size: 180%;"><i class="fa fa-search"></i><br />Programas Abertos</p>
								</div>
								<div class="innerAll">
									<label class="label label-info-light" style="font-size: 100%; background-color: #cb4040;"><a href="<?php echo base_url();?>index.php/in/dados_siconv/busca_programas" style="text-decoration: none; color: #fff"><?php echo $total_rows ;?> Programas Abertos</a></label>
								</div>
							</div>
						</div>
					</div>
...
<!--	<div style="background-color: #9dd3af; width: 100%;" class="innerAll box_vencimento">
	...
	if($vencimento_dia != null || $vencimento_cinco_dias != null || $vencimento_dez_dias != null){
		...
		echo '<h1 style="color: #cb4040" class="content-heading"><img src="'.base_url('layout/assets/images/warning.jpg').'" height="20"> Atenção <img src="'.base_url('layout/assets/images/warning.jpg').'" height="20"></h1>';
		
		if($vencimento_dia != null)
			echo "<h4>Programas com vencimento de vigência hoje. <a href='#' style='color: #cb4040' id='do_dia'>Clique aqui</a></h4>";
		
		if($vencimento_cinco_dias != null)
			echo "<h4>Programas com vencimento de vigência faltando 5 dias. <a href='#' style='color: #cb4040' id='cinco_dias'>Clique aqui</a></h4>";
		
		if($vencimento_dez_dias != null)
			echo "<h4>Programas com vencimento de vigência faltando 10 dias <a href='#' style='color: #cb4040' id='dez_dias'>Clique aqui</a></h4>";
		echo '</div>';
	}
	?>
