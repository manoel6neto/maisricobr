...
<div id="content" class="innerAll bg-white">
    ...
    <form class="form-horizontal" role="form" name="carrega_dados" method="post" id="carrega_dados" action="visualiza_propostas_pareceres">
        <input type="hidden" name="geral" id="geral" value="<?php if (isset($geral)) {
    echo $geral;
} ?>"/>
    </form>
    ...
    echo $filtro['status_prop'];
        ...
        <?php echo $propostas->ano; ?>
                    ...
                    <td><?php echo $propostas->objeto; ?></td>
                        <td><?php echo $programa_model->formatCPFCNPJ($propostas->proponente) . " - " . $cnpj_siconv->get_nome_by_cnpj($propostas->proponente, true); ?></td>
                ...
                <?php if (isset($geral)): ?>
                        <td style="min-width: 80px;"><a href="detalha_propostas_pareceres?geral=1&id=<?php echo $propostas->id_proposta; ?>">Detalhes e Pareceres</a></td>
                <?php else: ?>
