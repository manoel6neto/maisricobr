...
<div id="content" class="innerAll bg-white">
    ...
    <div class="form-group">
        <?php echo form_label('Filtro palavras chave email (separadas por ponto virgula [;])', 'filtro_email', array('class' => (form_error('filtro_email') != "" ? "error" : ""))); ?>
        <?php echo form_textarea(array('name' => 'filtro_email', 'style' => 'width: 50%;', 'class' => 'form-control '), set_value('filtro_email', isset($usuario) ? $usuario->filtro_email : '')); ?>
    </div>
    ...
    <div id="dadosSiconv">
        ...
        <div class="form-group">
            ...
            <?php echo form_input(array('name' => 'login_siconv', 'class' => 'form-control campoNumerico', 'id' => 'login_siconv', 'oncontextmenu' => "return false;", 'autocomplete' => 'off'), set_value('login_siconv', isset($usuario) ? $usuario->login_siconv : '')); ?>
        </div>

        <div class="form-group">
            <?php echo form_label('Senha SICONV', 'senha_siconv'); ?>
            <?php echo form_password(array('name' => 'senha_siconv', 'class' => 'form-control', 'id' => 'senha_siconv', 'placeholder' => '*******', 'oncontextmenu' => "return false;", 'autocomplete' => 'off'), set_value('senha_siconv', isset($usuario) ? '' : '')); ?>
        </div>
