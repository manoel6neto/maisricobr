...
<?php if($this->session->userdata('usuario_sistema') == 'P' || ($dados_usuario->id_nivel == 2 && $this->session->userdata('nivel') == 1) || ($dados_usuario->id_nivel == 6 && ($this->session->userdata('nivel') == 2 || $this->session->userdata('nivel') == 1))):?>
<br/>
