...
class get_proponentes extends CI_Controller {
    ...
    public function get_proponentes_siconv_from_html() {
        ...
        for ($count_id = $id_inicial; $count_id <= $id_final; $count_id++) {
            try {
                ...
                // ---- Dados do Proponente ---- //                
                $pagina = "https://www.convenios.gov.br/siconv/ConsultarParticipe/ResultadoDaConsultaDetalhar.do?id={$count_id}";
