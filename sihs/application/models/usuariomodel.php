...
class usuariomodel extends CI_Model {
    ...
    public function update_by_array($id_usuario, $options) {
        $this->db->where('id_usuario', $id_usuario);
                                    ...
                                    <div align='center' style='font-family: arial; margin-left: 20px;'>
                                        ...
                                        <div align='left'  style='width: 550px; margin-top: 50px;'>
                                            <div style='margin-left: 20px; padding-right:1px; font-size: 17px; width: 500px;'>
                                                ...
                                                <p>Sua mensagem foi recebida com sucesso no sistema SIHS.</p>
        ...
        if ($query->num_rows > 1) {
            ...
            if ($query->row(0)->usuario_sistema != 'T') {
                ...
                if ($nivel_usuario->id_nivel_usuario == '2' || $nivel_usuario->id_nivel_usuario == '9') {
                    ...
                    $this->load->model('gestor');
                    if ($usuario->id_nivel == 7 || $usuario->id_nivel == 8) {
                        $gestor = $this->gestor->get_by_user_id($gestor_do_usuario->id_gestor);
                    } else {
...
//                    $this->db->where('usuario.id_usuario', $this->session->userdata('id_usuario'));
            ...
            case 6:
                ...
                $query = $this->db->query("select usuario.*, nivel_usuario.nome AS nome_nivel from usuario join (nivel_usuario) on (nivel_usuario.id_nivel_usuario = usuario.id_nivel) where usuario.id_usuario in (select usuario.id_usuario from usuario join (usuario_subgestor) on (usuario_subgestor.id_gestor = {$id_usuario} and usuario_subgestor.id_usuario = usuario.id_usuario)) or usuario.id_usuario = {$id_usuario};");
//                $this->db->select("usuario.*, nivel_usuario.nome AS nome_nivel");
//                $this->db->join('usuario_subgestor', "usuario_subgestor.id_usuario = {$id_usuario} or (usuario_subgestor.id_gestor = {$id_usuario} and usuario_subgestor.id_usuario = usuario.id_usuario)");
...
////                $this->db->or_where('usuario.id_usuario', $this->session->userdata('id_usuario'));
                                ...
                                <div align='center' style='font-family: arial; margin-left: 20px;'>
                                    ...
                                    <div align='left'  style='width: 550px; margin-top: 50px;'>
                                        <div style='margin-left: 20px; padding-right:1px; font-size: 17px; width: 500px;'>
                                            ...
                                            <p>Seu cadastro foi efetuado com sucesso no Sistema SIHS.</p>
                                            <p>
                                        ...
                                        <div style='margin-top: 40px; margin-bottom: 40px; margin-right: 35px;' align='center'>
                                            <a href='{$urlSistema}'>Acesso ao sistema</a>
                                        </div>
                                        <br>
                                        <div style='margin-left: 20px; font-size: 17px;'>
                                            <p>Atenciosamente,</p>
    ...
    public function envia_email_confirma_cadastro($email, $nome, $cpf, $temLoginSiconv, $senha, $reenvio = false) {
        ...
        $urlSistema = "http://secretaria.physisbrasil.com.br/sihs/index.php/confirma_email?token=" . base64_encode($email);
    ...
    public function envia_email_automatico($email, $nome) {
                            ...
                            <div align='center' style='background-color: #ffffff; width: 580px; color: #666666; border: solid #aaaaaa; border-width: 1px; border-radius: 1%;'>
                                <div align='center' style='font-family: arial; margin-left: 20px;'>
                                    ...
                                    <div align='left'  style='width: 550px; margin-top: 50px;'>
                                        <div style='margin-left: 20px; padding-right:1px; font-size: 17px; width: 500px;'>
                                            <p style='font-size: 24px; font-weight: bold; color: #63cf9c;'>Olá, {$nome}</p>
                                            <p>Sua mensagem foi recebida com sucesso no sistema SIHS SIHS.</p>
        ...
        $this->email->subject("Suporte SIHS");
        $this->email->message($mensagem);
        $this->email->send();
    }
