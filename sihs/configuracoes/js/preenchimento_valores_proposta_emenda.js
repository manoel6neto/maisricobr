...
//function registraRepasseEspecifico(campo, messagem, maximo, outros) {
...
//    atribuirEventosExibirTotais("#salvarValorRepasseespecifico");
...
//		if($("#salvarValorContrapartidaFinanceira").val() == ""){
...
//        exibirValorCentavosFormatado("#salvarValorRepasseespecifico", calcularRepasse());
    ...
    function validarCamposMenoresQueValorGlobal(exibirMensagem) {
        ...
        if (valContrapartidaFinanceira > valValorGlobal) {
            ...
            exibirMensagemCampo("#mensagemContrapartidaFinanceira", true, "");
        ...
        if (valContrapartidaBensServicos > valValorGlobal) {
            ...
            exibirMensagemCampo("#mensagemContrapartidaBensServicos", true, "");
        ...
        if ((true == validarTotal) && (valTotalContrapartida > valValorGlobal)) {
            ...
            exibirMensagemCampo("#mensagemContrapartida", true, "");
        ...
        for (i = 0; i < camposRepasse.length; i++) {
            ...
            if (valValorRepasse > valValorGlobal) {
                ...
                exibirMensagemCampo("#mensagemRepasse" + camposRepasse[i], true, "");
        }
        ...
        if (valValorRepasse > valValorGlobal) {
            ...
            exibirMensagemCampo("#mensagemRepasse", true, "");
